    ...
    >
      ...
      >
        ...
        <el-form-item label="题目列表" prop="problems_list">
          <el-select v-model="competition.problems_list" multiple placeholder="选择竞赛题目">
            <el-option v-for="id in availableProblems" :key="id" :label="`题目 ${id}`" :value="id"></el-option>
          </el-select>
          <div class="tip-text">* 可以在创建后继续添加题目</div>
        </el-form-item>
